...
public class S3AFileSystemContractBaseTest extends FileSystemContractBaseTest {
    ...
    */
     ...
     *
     * @param fileSize the size of the file to be generated in bytes
     ...
     *
     * @param inputStream  the input stream to read the test data from
     * @param expectedSize the expected size of the data to be read from the input stream in bytes
     * @throws IOException thrown if an error occurs while reading the data
     */
