...
public class ZombieJob implements JobStory {
     ...
     * @param cluster The cluster topology where the dead job ran on. This argument can
     *                be null if we do not have knowledge of the cluster topology.
     * @param seed    Seed for the random number generator for filling in information
     ...
     *
     * @param mapAttemptCDFs A list of CDFs for the distribution of runtime for the 1st, 2nd,
