...
public abstract class YarnClient extends AbstractService {
     ...
     *
     * @param appContext {@link ApplicationSubmissionContext} containing all the details
     ...
     *
     * @param renewer Address of the renewer who can renew these tokens when needed by
     ...
     * </p>
     *
     * @param applicationAttemptId {@link ApplicationAttemptId} of the application attempt that needs
     *                             a report
