...
public interface ContainerManagementProtocol {
     ...
     * @throws IOException
     * @throws NMNotYetReadyException This exception is thrown when NM starts from scratch but has not
     ...
     * </p>
     *
     * @param request request to get <code>ContainerStatus</code>es of containers with
