...
public class TimelineEntity implements Comparable<TimelineEntity> {
     ...
     *
     * @param startTime the start time of the entity
     */
     ...
     *
     * @param events events a list of events related to the entity
     */
     ...
     *
     * @param event a single event related to the entity
     */
     ...
     *
     * @param events a list of events related to the entity
     */
     ...
     *
     * @param relatedEntities a map of related entities
     */
     ...
     *
     * @param primaryFilters a map of primary filters
     */
     ...
     *
     * @param key   the primary filter key
     ...
     *
     * @param otherInfo a map of other information
     */
     ...
     * map
     *
     * @param key   the other information key
     * @param value the other information value
     */
     ...
     *
     * @param domainId the name space ID
     */
