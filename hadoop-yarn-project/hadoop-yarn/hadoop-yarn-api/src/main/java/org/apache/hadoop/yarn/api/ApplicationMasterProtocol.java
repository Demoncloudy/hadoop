...
public interface ApplicationMasterProtocol {
     ...
     * @throws IOException
     * @throws InvalidApplicationMasterRequestException The exception is thrown when an ApplicationMaster tries to
     ...
     * @throws YarnException
     * @throws IOException
     * @throws InvalidApplicationMasterRequestException This exception is thrown when an ApplicationMaster calls allocate
     *                                                  without registering first.
     * @throws InvalidResourceBlacklistRequestException This exception is thrown when an application provides an invalid
     *                                                  specification for blacklist of resources.
     * @throws InvalidResourceRequestException          This exception is thrown when a {@link ResourceRequest} is out of
