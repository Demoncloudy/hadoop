...
class DirectoryCollection {
     ...
     *
     * @param dirs directories to be monitored
     */
     ...
     *
     * @param dirs                        directories to be monitored
     * @param utilizationPercentageCutOff percentage of disk that can be used before the dir is taken out of
     *                                    the good dirs list
     */
     ...
     *
     * @param dirs                   directories to be monitored
     * @param utilizationSpaceCutOff minimum space, in MB, that must be available on the disk for the
