...
public class TestProcfsBasedProcessTree {
     ...
     * @param procs         corresponding ProcessStatInfo objects whose data should be written
     *                      to the stat files.
     ...
     *
     * @throws IOException if there was a problem setting up the fake procfs directories or
     *                     files.
     */
    @Test(timeout = 30000)
