...
<head>
    ...
    <title>Hadoop <%=namenodeRole%>&nbsp;<%=namenodeLabel%>
    </title>
</head>
<body>
...
<b><%= NamenodeJspHelper.getSecurityModeText()%>
</b>
<b><%= NamenodeJspHelper.getSafeModeText(fsn)%>
</b>
<b><%= NamenodeJspHelper.getRollingUpgradeText(fsn)%>
</b>
<b><%= NamenodeJspHelper.getInodeLimitText(fsn)%>
</b>
...
<hr/>
<p><a href="http://hadoop.apache.org/core">Hadoop</a>, 2013.&nbsp;<a href="dfshealth.html">New UI</a></p>
</body>
</html>
