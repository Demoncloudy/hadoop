...
public class TestSnapshotReplication {
     ...
     * @param snapshotRepMap   A map maintaining all the snapshots of the current file, as well
     *                         as their expected replication number stored in their corresponding
     *                         INodes
     * @param expectedBlockRep The expected replication number that should be returned by
