...
class ConfigMerger {
     ...
     * overwritten
     *
     * @param opts the parsed command line option output
     * @param base the base configuration to merge with
     * @return merged configuration object
     * @throws ConfigException when configuration errors or verification occur
     */
     ...
     * @param opts      the parsed command line option output
     * @param base      the base configuration to merge with
     * @param extractor the access object to fetch operations from if none from the
     *                  command line
     * @return merged configuration object
     * @throws ConfigException when verification fails
     */
