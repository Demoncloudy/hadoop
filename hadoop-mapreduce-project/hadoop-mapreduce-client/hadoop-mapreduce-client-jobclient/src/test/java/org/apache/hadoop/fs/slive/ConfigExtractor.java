...
class ConfigExtractor {
    ...
    /**
     * @param primary primary the initial string to be used for the value of this
     ...
     * @param primary the initial string to be used for the value of this configuration
