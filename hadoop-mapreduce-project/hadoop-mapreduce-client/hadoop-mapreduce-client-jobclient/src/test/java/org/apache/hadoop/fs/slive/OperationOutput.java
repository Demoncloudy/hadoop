...
class OperationOutput {
     ...
     * segments.
     *
     * @param key   the key in expected dataType:operationType*measurementType format
     * @param value a generic value expected to match the output type
     ...
     *
     * @param o1 the first object to merge with the second
     * @param o2 the second object.
     * @return OperationOutput merged output.
     * @throws IllegalArgumentException if unable to merge due to incompatible formats/types
     */
