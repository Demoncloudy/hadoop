...
class DataVerifier {
     ...
     *
     * @param bufferSize size which must be greater than BYTES_PER_LONG and which also must
     ...
     *
     * @param byteAm the byte amount to limit to (should be less than or equal to file
     *               size)
     * @param in     the input stream to read from
     * @return VerifyOutput with data about reads
     * @throws IOException      if a read failure occurs
     * @throws BadFileException if a header can not be read or end of file is reached
     *                          unexpectedly
     */
