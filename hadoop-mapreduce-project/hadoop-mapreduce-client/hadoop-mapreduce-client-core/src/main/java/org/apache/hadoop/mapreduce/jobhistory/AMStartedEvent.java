...
public class AMStartedEvent implements HistoryEvent {
     ...
     * @param startTime           the start time of the AM.
     * @param containerId         the containerId of the AM.
     * @param nodeManagerHost     the node on which the AM is running.
     * @param nodeManagerPort     the port on which the AM is running.
     * @param nodeManagerHttpPort the httpPort for the node running the AM.
     */
     ...
     * @param nodeManagerPort          the port on which the AM is running.
     * @param nodeManagerHttpPort      the httpPort for the node running the AM.
     * @param forcedJobStateOnShutDown the state to force the job into
     */
    public AMStartedEvent(ApplicationAttemptId appAttemptId, long startTime,
                          ContainerId containerId, String nodeManagerHost, int nodeManagerPort,
