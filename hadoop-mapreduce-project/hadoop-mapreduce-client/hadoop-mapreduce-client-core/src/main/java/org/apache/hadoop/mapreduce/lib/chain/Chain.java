...
public class Chain {
     ...
     * @param confKey the key for chain element configuration serialized in the chain
     *                job's Configuration.
     ...
     * @param reducerConf      a configuration for the Reducer class. It is recommended to use a
     *                         Configuration without default values using the
     *                         <code>Configuration(boolean loadDefaults)</code> constructor with
     *                         FALSE.
     */
